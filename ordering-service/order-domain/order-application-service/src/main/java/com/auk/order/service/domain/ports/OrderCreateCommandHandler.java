...
import com.auk.order.service.domain.OrderDomainService;
...
import com.auk.order.service.domain.mapper.OrderDataMapper;
import com.auk.order.service.domain.ports.output.repository.CustomerRepository;
import com.auk.order.service.domain.ports.output.repository.OrderRepository;
import com.auk.order.service.domain.ports.output.repository.RestaurantRepository;
...
public class OrderCreateCommandHandler {
    ...
    public CreateOrderResponse createOrder(CreateOrderCommand createOrderCommand){
        ...
        OrderCreatedEvent orderCreatedEvent= orderDomainService.validateAndIntiateOrder(order,restaurant);
